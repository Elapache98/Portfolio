...
// Toolbar scroll behavior for explore and bertie pages - desktop only
if ((window.location.pathname.includes('explore.html') || 
     window.location.pathname.includes('bertie-sidekick.html') ||
     window.location.pathname.includes('explore') ||
     window.location.pathname.includes('bertie-sidekick')) &&
  ...
  function updateToolbar() {
    ...
    // Show toolbar if at top of page
